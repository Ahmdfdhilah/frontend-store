    ...
    return (
        <>
            ...
            <section className="py-5">
                <Container>
                    <h3 className="text-center mb-4 pb-2 text-success fw-bold">FAQ</h3>
                    ...
                    <Row>
                        <Col md={6} lg={4} className="mb-4">
                            <div className="text-success mb-3"><i className="far fa-question-circle text-success pe-2"></i> How can I track my order?</div>
                            <p>
                        ...
                        <Col md={6} lg={4} className="mb-4">
                            <div className="text-success mb-3"><i className="fas fa-shipping-fast text-success pe-2"></i> What are your shipping options?</div>
                            <p>
                        ...
                        <Col md={6} lg={4} className="mb-4">
                            <div className="text-success mb-3"><i className="far fa-credit-card text-success pe-2"></i> What payment methods do you accept?</div>
                            <p>
                        ...
                        <Col md={6} lg={4} className="mb-4">
                            <div className="text-success mb-3"><i className="fas fa-exchange-alt text-success pe-2"></i> Can I return or exchange a product?</div>
                            <p>
                        ...
                        <Col md={6} lg={4} className="mb-4">
                            <div className="text-success mb-3"><i className="fas fa-shield-alt text-success pe-2"></i> Is my payment information secure?</div>
                            <p>
                        ...
                        <Col md={6} lg={4} className="mb-4">
                            <div className="text-success mb-3"><i className="fas fa-user-lock text-success pe-2"></i> How do you protect my personal information?</div>
                            <p>
